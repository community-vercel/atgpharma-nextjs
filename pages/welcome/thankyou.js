...
function Welcome() {
  return (
    <div>
      ...
      <div className="min-h-screen  bg-atgBlue flex flex-col items-center justify-between bg-connectGray py-14 px-8">
        <div className="max-w-md w-full space-y-8">
          <div>
            ...
            <h2 className="mt-12 text-left text-4xl font-medium text-white flex flex-col gap-3">
              <span className="block"> Our team</span>
              <span className="block"> will be in touch</span>
              <span className="block"> shortly!</span>
            </h2>
            <p className="mt-6 text-left  text-white">
              We are anxious to connect with you on your request. in the
              meantime, feel free to use our build and price page for more info
              .
            </p>
          </div>
          <form className="mt-8 space-y-6">
            <div>
              <a
                href="/build"
                className="group relative w-full flex justify-center py-2 px-4 border border-transparent  font-medium rounded-md text-atgBlue bg-white hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
              >
